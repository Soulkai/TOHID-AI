...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '5521967683259' ; // put your number here
...
//
global.botname = process.env.BOTNAME || 'MW Bot';
global.pairingNumber = process.env.BOT_NUMBER || '5521967683259' ;  // put your number here
